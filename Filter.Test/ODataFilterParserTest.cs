...
namespace Sidub.Platform.Filter.Test
{
    ...
    public class ODataFilterParserTest
    {
        ...
        public void ODataFilterParserTest_FilterString01()
        {
            ...
            Assert.AreEqual("FieldA eq 'FieldATestValue'", filterString);
        }
        ...
        public void ODataFilterParserTest_FilterString02()
        {
            ...
            Assert.AreEqual("(FieldA eq 'FieldATestValue' and FieldB ne 'FieldBTestValue')", filterString);
        }
        ...
        public void ODataFilterParserTest_FilterString03()
        {
            ...
            Assert.AreEqual("(FieldA eq 'FieldATestValue' and (FieldB eq 'FieldBTestValue01' or FieldB eq 'FieldBTestValue02'))", filterString);
        }
