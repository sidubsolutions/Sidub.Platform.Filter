...
namespace Sidub.Platform.Filter.Parsers.Gremlin
{
    ...
    /// <summary>
    /// Gremlin filter parser for logical operator.
    /// </summary>
    public class FilterParserLogicalOperator : IFilterParser
    {
        ...
        /// </summary>
        /// <typeparam name="T">The type of the filter parser configuration.</typeparam>
        /// <param name="filterParserService">Filter parser service.</param>
        /// <param name="filter">Filter to parse.</param>
        /// <returns>Filter string.</returns>
        public string ParseFilter<T>(IFilterService<T> filterParserService, IFilter filter) where T : IFilterServiceConfiguration, new()
        {
